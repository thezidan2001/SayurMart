							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									<div class="product-thumnail">
										<a href="/product/{{ $product->id }}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
											<figure><img src="build/assets/images/products/digital_20.jpg" alt="T-Shirt Raw Hem Organic Boro Constrast Denim"></figure>
										</a>
									</div>
									<div class="product-info">
										<a href="/product/{{ $product->id }}" class="product-name"><span>{{ $product->product_name }}</span></a>
